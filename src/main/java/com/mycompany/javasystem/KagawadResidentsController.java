...
public class KagawadResidentsController {
...
private void loadResidents(String search) {
    ...
    try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            viewBtn.setOnAction(e -> {
                try {
                    FXMLLoader loader = new FXMLLoader(
                        getClass().getResource("KagawadViewResidentModal.fxml")
                    );
                    Parent modalRoot = loader.load();

                    KagawadViewResidentController viewController = loader.getController();
                    ...
                    showErrorAlert("Unable to open resident details.", ex);
                }
            });
        ...
        showErrorAlert("Unable to load residents.", e);
            ...
            if (items.isEmpty()) {
                ...
                for (String[] item : items)
                    notifBody.getChildren().add(
                        buildNotifItem(item, loadNotifsRef, alertStage));
            }
...
private VBox buildNotifItem(String[] item, Runnable[] loadNotifsRef, Stage alertStage) {
