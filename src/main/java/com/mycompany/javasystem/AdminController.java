...
public class AdminController {
    ...
    private Node buildUsersTab() {
        ...
        cards.getChildren().addAll(
            buildMiniCard("Total Users", String.valueOf(counts[0]), "#1a1a1a", "#ffffff", "👥"),
        ...
        // Set column resize after adding to table
        Platform.runLater(() -> {
            transactionTable_setColumnResizePolicy(table);
        });
    ...
    // Fix: set resize after layout pass
    private void transactionTable_setColumnResizePolicy(TableView<String[]> table) {
        table.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
    }
    ...
    private Node buildPasswordTab() {
        ...
        container.setStyle(
            "-fx-background-color: #ffffff; -fx-background-radius: 16;" +
            "-fx-border-color: #e8e8e8; -fx-border-width: 1; -fx-padding: 36;");
    ...
    private Node buildStatsTab() {
        ...
        VBox resSection = buildStatSection("Residents", new String[][]{
            {"Total Residents", String.valueOf(residents),                "#1a1a1a", "#ffffff"},
    ...
    private VBox buildStatSection(String sectionTitle, String[][] items) {
        ...
        sectionLbl.setStyle(
            "-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: #999999;" +
            "-fx-padding: 0 0 2 0;");
