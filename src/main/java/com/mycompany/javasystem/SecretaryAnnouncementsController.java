...
public class SecretaryAnnouncementsController {
    ...
    private void openModal(String annId, String title, String content,
        ...
        try {
            FXMLLoader loader = new FXMLLoader(
                getClass().getResource("SecretaryAnnouncementsModal.fxml"));
            Parent root = loader.load();
            SecretaryAnnouncementsModalController ctrl = loader.getController();
